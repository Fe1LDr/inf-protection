...
if __name__ == '__main__':
    # encode_lsb(image='input-files/1.bmp', file_to_encode='input-files/file.txt', image_encoded='output-files/new_image.bmp')
    decode_lsb(file_to_decode='input-files/1.bmp', file_decoded='output-files/newfile.txt')
